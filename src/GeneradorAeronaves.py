...
def generador(evento):
    ...
    pasajeros = cantidadPasajeros() # genera un numero random de pasajeros
...
def cantidadPasajeros():
    vuelo = random.choice(['bajo','medio','alto','muy alto'])
    if vuelo == 'bajo':
        return random.randint(100,150)
    elif vuelo == 'medio':
        return random.randint(150,190)
    elif vuelo == 'alto':
        return random.randint(190,240)
    else:
