...
\begin{itemize}
    \item \textbf{Condiciones meteorlógicas adversas:} Pueden reducir la capacidad de aproximación y despegue, afectan tanto a las aeronaves como al flujo de pasajeros.
...
El modelo propuesto se basa en una simulación de eventos discretos, dinámicos y estocásticos. Dicho sistema avanza cada vez que ocurren eventos relevantes, como puede ser la llegada o el aterrizaje de una aeronave.
\\
\\
...
\\
\\
Además, no permite operaciones simultáneas; por tanto, serán secuenciales. Por lo tanto, habrá una pista con la capacidad de despegue y aterrizaje.
\\
\\
Este enfoque permite que el flujo de las operaciones sea ordenado y que se puedan analizar indicadores como el tiempo promedio de espera de cada avión que está en la cola, el tamaño de dicha cola, el nivel de utilización de dicha pista, etc.
...
Determinaron que el AICM tenía operaciones cercanas a su máxima capacidad y propusieron ajustes operativos para mejorar la eficiencia. Usaron un simulador más antiguo, técnico y sencillo de codificar (SIMNET II).
