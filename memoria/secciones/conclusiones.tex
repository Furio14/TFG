...
\\
\\
Para comenzar se va a realizar una comparativa del Escenario Base de cada prototipo (Tabla \ref{tab:Comparativa Escenario Base}):
\begin{table}[H]
    \centering
    ...
    \begin{tabular}{|l|l|l|} 
        ...
        \hline
        Comportamiento General & Estable & Estocástico y Variable\\
