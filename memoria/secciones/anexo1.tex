...
En esta seccion se presentan los ficheros .py que forman parte del trabajo. Cada uno de ellos incluye un hipervínculo con una referencia a su correspondiente enlace en Github y se encarga de implementar funcionalidad específicas dentro del proyecto.
\\
\\
