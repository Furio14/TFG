...
\begin{lstlisting}[language = Python,frame = single,caption = {Generador de aeronaves},label=listing:A1,captionpos=b,breaklines=true,breakatwhitespace=false]
...
\end{lstlisting}
\begin{lstlisting}[language = Python,frame = single,caption = {Ciclo completo aeronaves},label=listing:A2,captionpos=b,breaklines=true,breakatwhitespace=false]
...
\end{lstlisting}
\begin{lstlisting}[language = Python,frame = single,caption = {Gestión de la Cola de Llegada},label=listing:A3,captionpos=b,breaklines=true,breakatwhitespace=false]
...
\end{lstlisting}
\begin{lstlisting}[language = Python,frame = single,caption = {Operación de Aterrizaje},label=listing:A4,captionpos=b,breaklines=true,breakatwhitespace=false]
...
\end{lstlisting}
\begin{lstlisting}[language = Python,frame = single,caption = {Operación de Estacionamiento},label=listing:A5,captionpos=b,breaklines=true,breakatwhitespace=false]
    ...
    def controlEstacionados(evento,parking,colaEstacionados,colaSalidas,estadoClima,mes,aeronaves):
        if colaEstacionados:
            ...
            yield evento.timeout(0.1)
\end{lstlisting}
\begin{lstlisting}[language = Python,frame = single,caption = {Programación de Salida},label=listing:A6,captionpos=b,breaklines=true,breakatwhitespace=false]
    ...
    def controlSalidas(evento,anuncio,colaSalidas,colaDespegues,estadoClima,mes,aeronaves):
        if colaSalidas:
            ...
            yield evento.timeout(0.1)
\end{lstlisting}
\begin{lstlisting}[language = Python,frame = single,caption = {Operación de Despegue},label=listing:A7,captionpos=b,breaklines=true,breakatwhitespace=false]
    ...
    def controlDespegues(evento,parking,pista,colaDespegues,estadoClima,mes,turnos,aeronaves):
        if colaDespegues:
            ...
            yield evento.timeout(0.1)
\end{lstlisting}
\begin{lstlisting}[language = Python,frame = single,caption = {Tasa Horarios},label=listing:A8,captionpos=b,breaklines=true,breakatwhitespace=false]
...
\end{lstlisting}
\begin{lstlisting}[language = Python,frame = single,caption = {Factores Externos},label=listing:A9,captionpos=b,breaklines=true,breakatwhitespace=false]
