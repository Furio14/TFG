...
Las estructuras de datos proporcionadas por la librería {\em simpy} para gestionar la concurrencia y las colas:
\begin{table}[h!]
    \centering
    \begin{tabular}{|c|c|c|}
        \hline
...
El usuario del simulador puede definir diferentes parámetros de entrada, los cuales determinan el comportamiento del simulador y afectan en su desarrollo:
...
En este apartado se presentarán los parámetros utilizados en cada uno de los escenarios, con el fin de analizar posteriormente las diferencias entre ellos.
\begin{table}[H]
    \centering
