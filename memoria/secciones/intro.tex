...
\begin{itemize}
    ...
    \item El \textbf{Capítulo 4} detalla el desarrollo e implementación del primer prototipo.
    \item El \textbf{Capítulo 5} detalla el desarrollo e implementación del segundo prototipo.
