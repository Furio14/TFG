...
\\
\\
Por ello, es fundamental poder anticiparse. Desarrollar un simulador es la estrategia mas inteligente, ya que nos permite crear escenarios complejos y medir la eficiencia del aeropuerto de manera segura y barata.
...
\begin{itemize}
    \item El \textbf{Capítulo 2} está dedicado al estudio del arte, donde se analizan los principales conceptos teóricos, trabajos previos y metodologías existentes.
    \item El \textbf{Capítulo 3} describe el modelo empírico descriptivo del proyecto, detallando los componentes que definen el funcionamiento de un aeropuerto en el mundo real.
    \item El \textbf{Capítulo 4} detalla el desarrollo del primer prototipo.
    \item El \textbf{Capítulo 5} detalla el desarrollo del segundo prototipo.
    \item El \textbf{Capítulo 6} presenta los resultados obtenidos a partir de la simulación y recoge las conclusiones obtenidas tras el desarrollo del proyecto.
    \item Finalmente, el \textbf{Capítulo 7} incluye la bibliografía, los anexos y las referencias empleadas a lo largo del trabajo.
\end{itemize}
